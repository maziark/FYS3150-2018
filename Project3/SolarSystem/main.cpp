...
void testEn (){
    ...
    ss_v.addCelestialObj(" Sun (10) ",  1.0 , vec3( 0.0 ,  0.0 ,  0.0 ) , vec3( 0.0 ,  0.0 ,  0.0 ));
    ss_v.addCelestialObj(" Mercury (199) ",  3e-06 , vec3( -0.110692716399 ,  -0.452571796847 ,  -0.0268264553904 ) , vec3( 7.9137485748 ,  -1.92341214333 ,  -0.883162004382 ));
    ss_v.En = true;

    //EulerAlgorithm e(pow(10, double(-1 * i)));
    VerletAlgorithm v(10e-6);
    v.runFor(ss_v, 10.0, "body2.txt");

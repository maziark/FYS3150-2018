...
def RK4_deadly ():
    ...
    (t_array_B, S_array_B, I_array_B, R_array_B) = sirs_B.RK4(300.0, 100.0, 200.0)
    (t_array_C, S_array_C, I_array_C, R_array_C) = sirs_C.RK4(300.0, 100.0, 200.0)
    (t_array_D, S_array_D, I_array_D, R_array_D) = sirs_D.RK4(300.0, 100.0, 200.0)
